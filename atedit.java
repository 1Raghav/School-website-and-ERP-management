 ...
 * @author Vinay B K
 */
@WebServlet(name = "atedit", urlPatterns = {"/atedit"})
public class atedit extends HttpServlet {
...
"  <a href=\"dues.jsp\"><i class='far fa-clipboard'></i> Dues</a>\n"
                ...
                out.println("<form action='atupdate' method='POST'>");
                ...
                out.println(" <div class=\"form-group\">");
                out.println("<tr><td>Date</td> <td><input type='date' class='form-control' name='date' value='" + s.getdate() + "' </td></tr>");
                out.println("</div>");

                out.println(" <div class=\"form-group\">");
                out.println("<tr><td>Total No of Classes</td> <td><input type='text' class='form-control' name='clstaken' value='" + s.getclstaken() + "' </td></tr>");
                out.println("</div>");

                out.println(" <div class=\"form-group\">");
                out.println("<tr><td>Classes Attended</td> <td><input type='text' class='form-control' name='clsattended' value='" + s.getclsattended() + "' </td></tr>");
                out.println("</div>");

//                out.println(" <div class=\"form-group\">");
//                out.println("<tr><td>percentage</td> <td><input type='text' class='form-control' name='percentage' value='" + s.getpercentage() + "' </td></tr>");
                out.println("</table>");

                out.println(" <div class=\"form-group\">");
                out.println(" <td><br> <input type='submit' class='btn btn-info btn-lg btn-block' name='submit' value='Update'/></td>");
                out.println("</div>");
                
                out.println("</form></div></center></div></div><footer>\n" +
