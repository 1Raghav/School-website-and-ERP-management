    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <a class="dropdown-item" href="logout?logout=logout">Logout</a>
            ...
            <div class="container">
<center><h3>-: <u>Dues Details</u> :-</h3></center><br>
        ...
        <table border="4" cellspacing="15" align="center" id="customers">
            <tr>  
                ...
                <TH bgcolor="#6CBFE8"><center>Total Fees</center></TH>
                <TH bgcolor="#6CBFE8" ><center>Amount Paid</center></TH>
                <TH bgcolor="#6CBFE8" ><center>Fees Balance</center></TH>
...
<%if (session.getAttribute("studentid") != null) {%>
            ...
            <tr>
                ...
                <td align="center" width="8%"><%=f.getsec()%></td>  
                <td align="center" width="5%"><%=f.gets_id()%></td> 
