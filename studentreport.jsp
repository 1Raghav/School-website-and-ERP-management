...
<%if (session.getAttribute("facultyid") != null) {%>
                <center><h3>-: <u>Class Report</u> :-</h3></center><br>
                <table border="4" cellspacing="15" align="center" id="customers"> 

                    <tr>  
                        <TH bgcolor="#6CBFE8" ><center>Student Id</center></TH>
                        <TH bgcolor="#6CBFE8" colspan="2">Name</center></TH>
                        
                        <TH bgcolor="#6CBFE8"><center>Class</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Sec</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>IA</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>English marks</center></TH>
                        <TH bgcolor="#6CBFE8"><center>Kannada marks</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Hindi marks</center></TH>
                        <TH bgcolor="#6CBFE8"><center>Science marks</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Social science marks</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Maths marks</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Total marks</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Percentage</center></TH>
                    </tr>  

                    <% ArrayList<rreport> mydata1 = (ArrayList) request.getAttribute("stdreport");
                        Iterator<rreport> itr = mydata1.iterator();
                        while (itr.hasNext()) {
                            rreport r = itr.next();%> 
                    <tr>
                        <td align="center" width="15%"><%=r.gets_id()%></td>  
                        <td align="center" width="15%" colspan="2"><%=r.gets_name1()%> <%=r.gets_name2()%></td> 
                        
                        <td align="center" width="15%"><%=r.getclassname()%></td> 
                        <td align="center" width="15%"><%=r.getsec()%></td>  
                        <td align="center" width="15%"><%=r.getia()%></td> 
                        <td align="center" width="15%"><%=r.getenglish()%></td> 
                        <td align="center" width="15%"><%=r.getkannada()%></td> 
                        <td align="center" width="15%"><%=r.gethindi()%></td>
                        <td align="center" width="15%"><%=r.getscience()%></td> 
                        <td align="center" width="15%"><%=r.getss()%></td>  
                        <td align="center" width="15%"><%=r.getmaths()%></td>
                        <td align="center" width="15%"><%=r.gettotal()%></td>
                        <td align="center" width="15%">(<%=r.getpercentage()%>%)</td>
                    </tr>
                    <%}%> 
                </table>
