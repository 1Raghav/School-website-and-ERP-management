...
<div class="bs-example">
    ...
    <div class="container">
                <div class="alert alert-success" role="alert">
                    <h4 class="alert-heading">You have Successfully Created Account...!!!<br></h4>
  <p>Now,You can login and Complete your Profile...</p>
  <hr>
  <p class="mb-0"><a href="login.jsp">Go to Login</a>.</p>
