...
<!--  <a href="#contact"><i class='far fa-clipboard'></i> Dues</a>-->
  <a href="#contact"><i class='far fa-question-circle'></i> FAQ's</a>
            ...
            <div class="container"><br>
                <h1 style="text-align: center">-: <u>Faculty Data</u> :-</h1>

                <table border="4" cellspacing="15" align="center" id="customers">
                    <tr>  
                        <TH bgcolor="#6CBFE8" colspan="2"><center>Name</center></TH>
                        
                        <TH bgcolor="#6CBFE8" ><center>Faculty ID</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Email Id</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Phone No</center></TH>
                        <TH bgcolor="#6CBFE8"><center>Subject</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Qualification</center></TH>
                        <TH bgcolor="#6CBFE8" ><center>Experience</center></TH>
                        <TH bgcolor="#6CBFE8"><center>Address</center></TH>
                        <TH bgcolor="#6CBFE8"><center>About</center></TH>



                    </tr>  

                    <% ArrayList<faculty> mydata = (ArrayList) request.getAttribute("myatArray");
                    ...
                    <tr>
                        ...
                        <td align="center" width="10%"><%=s.getf_id()%></td> 
                        <td align="center" width="10%"><%=s.getf_email()%></td>
                        <td align="center" width="10%"> <%=s.getf_phone()%></td>
                        <td align="center" width="10%"><%=s.getf_subject()%></td>
                        <td align="center" width="10%"><%=s.getf_qualification()%></td>
                        <td align="center" width="15%"><%=s.getf_experience()%></td> 
                        <td align="center" width="15%"><%=s.getf_address()%> </td>
                        <td align="center" width="15%"><%=s.getf_about()%> </td>
            ...
            <br><br><br> 
            <br><br>
            </div><br><br><br><br><br><br><br><br><br><br><br><footer>
