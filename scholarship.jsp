   ...
   <div class="container"> 
    <body><center>
        ...
        <div class="signup-form">
         <form method="POST" id="freport" action="ssinput">
            <font size="4">
            <h2> Scholarship Details</h2>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="ss_name" placeholder="SCHOLARSHIP NAME" required>
                    </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="ss_link" placeholder="SCHOLARSHIP LINK" required>
                    </div>
