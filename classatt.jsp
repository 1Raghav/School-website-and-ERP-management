...
<!--  <a href="#contact"><i class='far fa-question-circle'></i> FAQ's</a>-->
   ...
   <div class="container"> 
       <div class="signup-form">
        ...
        <form method="POST" action="atfetch">
           <h2>Class Attendance</h2>
            
             
                   
                     <div class="form-group">
                         <td> <input type="text" class="form-control" name="classname" placeholder="CLASS" required > 
                     </div>
                        <div class="form-group">
                        <td> <input type="text" class="form-control" name="sec" placeholder="SECTION" required > 
                        </div>
                <div class="form-group">
                    <input type="submit" name="submit" class="btn btn-success btn-lg btn-block" value="Fetch"/>
                </div>
