...
<div class="signup-form">
         ...
         <form method="POST" id="freport" action="reportentry">
             <center><h1>IA Report Entry</h1></center><br>
	<div class="form-group">
            <input type="text" class="form-control" name="s_id" placeholder="Enter Student Id" required>
        </div>
        <div class="form-group">
            <input type="text" class="form-control" name="s_name1" placeholder="First Name" required>
      </div>
      <div class="form-group">
          <input type="text" class="form-control" name="s_name2" placeholder="Last Name" required>
       </div>
       <div class="form-group">
           <input type="text" class="form-control" name="classname" placeholder="Enter Class" required>
           </div>  
             <div class="form-group">
  ...
  <option value="B">B</option>
              ...
              <div class="form-group">
      <input type="text" class="form-control" name="eng" placeholder="English" required>
     </div>
     <div class="form-group">
     <input type="text" class="form-control" name="kan" placeholder="Kannada" required>
     </div>
           <div class="form-group">
     <input type="text" class="form-control" name="hindi" placeholder="Hindi" required>
     </div>
     
     <div class="form-group">
     <input type="text" class="form-control" name="sc" placeholder="Science" required>
     </div>
     <div class="form-group">
     <input type="text" class="form-control" name="ss" placeholder="Social Science" required>
     </div>
     <div class="form-group">
    <input type="text" class="form-control" name="math" placeholder="Mathematics" required>
    </div>
    
     
     
           <div class="form-group">
               <input type="submit" class="btn btn-success btn-lg btn-block"  name="submit" value="Upload IA Report" />
            </div>
        </form>
</div>     
