...
<!--  <a href="#contact"><i class='far fa-question-circle'></i> FAQ's</a>-->
    ...
    <!-- Demo Content -->    
    <div class="container"><% if (session.getAttribute("uname") != null) {%> 
       <div class="signup-form">
          
        <form method="POST" action="asdatafetch">
           <h2>Students Data</h2>
            
          
                   
                     <div class="form-group">
                         <td> <input type="text" class="form-control" name="classname" placeholder="CLASS" > 
                     </div>
                        <div class="form-group">
                        <td> <input type="text" class="form-control" name="sec" placeholder="SECTION" > 
                        </div>
                <div class="form-group">
                    <input type="submit" name="submit" class="btn btn-success btn-lg btn-block" value="Get Data">
                </div>
