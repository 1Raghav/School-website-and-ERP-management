    ...
    <body><%if (session.getAttribute("studentid") != null) {%>
        ...
        //                            ArrayList<User> mydata = (ArrayList) ar;
            ...
            student s = itr.next();%>
                            ...
                            <a href="t1.html">
                                <%} else if (s.gets_std().equals("9")) {%>
                                <a href="t2.html">
                                    <%} else if (s.gets_std().equals("8")) {%>
                                    <a href="t3.html">
                                        <%} else if (s.gets_std().equals("7")) {%>
                                        <a href="t4.html">
                                            <%} else if (s.gets_std().equals("6")) {%>
                                            <a href="t5.html">
                                                <%} else if (s.gets_std().equals("5")) {%>
                                                <a href="t6.html">
                                                    <%} else if (s.gets_std().equals("4")) {%>
                                                    <a href="t7.html">
                                                        <%} else if (s.gets_std().equals("3")) {%>
                                                        <a href="t8.html">
                                                            <%} else if (s.gets_std().equals("2")) {%>
                                                            <a href="t9.html">
                                                                <%} else if (s.gets_std().equals("1")) {%>
                                                                <a href="t10.html">
                                                                    <%}%>
                                                                ...
                                                                <div class="card bg-white">
                                                                    <div class="card-body text-center">
                                                                        <a href="sreport?report=report">
                                                                            <img src="images/report.png" width="60px" height="60px"><br>IA MARKS REPORT</a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <%}%>
                                                                <%} else {%>
                                                                <a href="studenr_login.html" class="nav-item nav-link"> please login</a> 
                                                                <%}%>
