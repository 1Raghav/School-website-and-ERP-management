<%-- 
    ...
    Created on : Aug 21, 2020, 2:59:42 AM
    Author     : Vinay B K
--%>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="navbar-brand"><img src="img/logo.jpeg" height="70"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="navbar-nav ml-auto">
                <a href="login.jsp" class="nav-item nav-link"><i class="fa fa-fw fa-user"></i>Login</a>
            </div>
        </div>
    </nav>
    <br>
...
<form method="POST" action="register">
  ...
  <option value="student">Student</option>
                ...
                <div class="form-group">
            <input type="text" class="form-control" name="id" placeholder="Enter your ID" required="required">
        </div>
		<div class="form-group">
            <input type="password" class="form-control" name="pw" placeholder="Password" required="required">
        </div>
		<div class="form-group">
            <input type="password" class="form-control" name="cp" placeholder="Confirm Password" required="required">
        </div>      
                <div class="form-group">
...
<!--<form method="POST" id ="signup" action="register">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="id" placeholder="First Name" required="required"></div>
				<div class="col"><input type="text" class="form-control" name="name" placeholder="Last Name" required="required"></div>
			</div>        	
        </div>
        <div class="form-group">
