...
<center><h3>-: <u>Scholarship Details</u> :-</h3></center><br>
       <table border="4" cellspacing="15" align="center" id="customers">
            <tr>  
                <TH bgcolor="#6CBFE8" ><center><h3><strong>Scholarship Name</strong></h3></center></TH>
       <TH bgcolor="#6CBFE8" ><center><h3><strong>Link for Application</strong></h3></center></TH>
               
               
            </tr>  
<%if (session.getAttribute("studentid") != null) {%>
            <% ArrayList<ssdata> mydata = (ArrayList) request.getAttribute("myssArray");
                Iterator<ssdata> itr = mydata.iterator();
                while (itr.hasNext()) {
                    ssdata f = itr.next();%> 
            <tr>
                <td align="center" width="15%"><%=f.getss_name()%></td>  
                <td align="center" width="15%"><a href="<%=f.getss_link()%>"><%=f.getss_link()%></a></td> 
