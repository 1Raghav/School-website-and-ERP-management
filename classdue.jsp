...
//                            ArrayList<User> mydata = (ArrayList) ar;
  ...
  <a href="#"><i class='far fa-building'></i> Academics</a>
  ...
  <a href="scholarship.jsp"><i class='far fa-edit'></i> Schoolarship</a>
...
<!--  <a href="#contact"><i class='far fa-question-circle'></i> FAQ's</a>-->
   ...
   <div class="container">
      ...
      <form method="POST" action="dfetch">
                ...
                <div class="form-group">
                    <input type="submit" name="submit" class="btn btn-success btn-lg btn-block" value="GET INFO"/>
                </div>
