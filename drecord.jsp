...
//                            ArrayList<User> mydata = (ArrayList) ar;
 ...
 <a href="academics2.jsp"><i class='far fa-calendar-alt'></i> Academics</a>
  <a href="#services"><i class='far fa-building'></i> Facilities</a>
...
<!--  <a href="#contact"><i class='far fa-question-circle'></i> FAQ's</a>-->
    ...
    <div class="container">
        <h1 style="text-align: center">-: <u>Students Dues</u> :-</h1>
        ...
        <table border="4" cellspacing="15" align="center" id="customers">
            <tr>  
                ...
                <TH bgcolor="#6CBFE8"><center>Total Fee</center></TH>
                <TH bgcolor="#6CBFE8" ><center>Amount Paid</center></TH>
                <TH bgcolor="#6CBFE8" ><center>Fee Balance</center></TH>
               
               
            </tr>  
<%if(session.getAttribute("facultyid")!=null){%>
            <% ArrayList<due_data> mydata = (ArrayList) request.getAttribute("mydueArray");
                Iterator<due_data> itr = mydata.iterator();
                while (itr.hasNext()) {
                    due_data f = itr.next();%> 
            <tr>
                <td align="center" width="15%" colspan="2"><%=f.getfname()%> <%=f.getlname()%></td>  
                
                <td align="center" width="10%"><%=f.getclassname()%></td> 
                <td align="center" width="10%"><%=f.getsec()%></td>  
                <td align="center" width="10%"><%=f.gets_id()%></td> 
                <td align="center" width="15%"><%=f.gettotalfee()%> /-</td> 
                <td align="center" width="15%"><%=f.getamountpaid()%> /-</td>  
                <td align="center" width="15%"><%=f.getfeebalance()%> /-</td> 
